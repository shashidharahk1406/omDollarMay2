...
export class AllProjectComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    .pipe(
      ...
      switchMap((query: string) =>this.api.getProject(this.point,this.user,this.user_id,this.currentPage+1,this.pageSize,query,this.sortValue,this.directionValue))).subscribe((resp:any)=>{
  ...
  pageChanged(event: PageEvent) {
    ...
    this.api.getProject(this.point,this.user,this.user_id,this.currentPage+1,this.pageSize,this.searchProject,this.sortValue,this.directionValue).subscribe((resp:any)=>{
      this.allProject= resp.result.data;
      this.totalPageLength=resp.result.pagination.len_of_data;
      this.totalDataCount=resp.result.pagination.total_len_of_data;
    },(error:any)=>{
  ...
  getProject(searchProject:any){
    this.api.getProject(this.point,this.user,this.user_id,this.currentPage+1,this.pageSize,searchProject,this.sortValue,this.directionValue).subscribe((resp:any)=>{
      this.allProject= resp.result.data;
      this.totalPageLength=resp.result.pagination.len_of_data;
      this.totalDataCount=resp.result.pagination.total_len_of_data;
